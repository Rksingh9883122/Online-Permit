...
EMAIL_ADDRESS = os.getenv("rksingh9883122@gmail.com")
EMAIL_PASSWORD = os.getenv("cbkw xsus zyht ryso")
BASE_URL = os.getenv("http://digital-permit-env-fixed.eba-3nrifmnv.ap-southeast-2.elasticbeanstalk.com")
        ...
        # ✅ ADD HERE
            ...
            #     permit_id = datetime.now().strftime("%Y%m%d%H%M%S")
                ...
                if issuer_email:
                    ...
                    base_url = os.getenv("BASE_URL")   # 🔥 replace later
                ...
                # --- PENDING HSE ---
                    ...
                    with c1:
                        if st.button("Approve (HSE)", key=f"btn_hse_{row['permit_id']}", type="primary"):
                            ...
                            if approver_email:
                                base_url = os.getenv("BASE_URL")   # 🔥 replace after deploy
